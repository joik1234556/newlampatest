...
(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.3', API = Protocol() + 'api.n.modss.tv/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, leftVipD = ' 💎 87 дней 5 часов', user_id = 234350575, uid = 'bb04b81f6297b1b6280ea8273_234350575', IP = '212.58.119.150', logged = true, VAST_url = false;
	
	console.log('Modss', 'plugin', '[POST] LOADED - ' + Protocol() + 'n.modss.tv');
...
var Modss = {
	...
	var button = "<div style='position:relative' data-subtitle='modss_v".concat(manifest.version, " (23 Balansers, 18 in VIP)' class='full-start__button selector view--modss_online'>" + ico + "<span>" + this.title + "</span><div style='position: absolute;left: 1em;bottom: 1em;background-color: rgb(255, 255, 255);color: rgb(0, 0, 0);padding: 0.1em 0.2em;font-size: 0.6em;border-radius: 0.5em;font-weight: 900;text-transform: uppercase;'>VIP</div></div>");
	  ...
	  rating_kp_imdb:function (card) {
        ...
        Pub.network.clear();
          ...
          original_title: card && (card.original_title || card.original_name) || logged,
  			  ...
  			  uid: uid,
  			  ips: '212.58.119.150',
          id: 'ZWdvcmtvcm90a292NUBnbWFpbC5jb20=',
          auth: logged
  			});
			});
		},
    ...
    balansers: function() {
      var balansers = {"veoveo":"VeoVeo","videx":"ViDEX","mango":"ManGo 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uaflix":"UaFlix <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\"> 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","eneida":"Eneida <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\">  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","fxpro":"FXpro 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","flixsod":"FlixSOD 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","alloha":"Alloha 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","filmix":"Filmix 4K","kinopub":"KinoPub 4K","hdr":"MODS's [4K, HDR]  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdrezka":"HDRezka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","aniliberty":"AniLiberty  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kodik":"Kodik  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinotochka":"KinoTochka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdvb":"HDVB  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","collaps":"Collaps  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","starlight":"StarLight  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>"};
...
function component(object) {
  ...
  this.initialize = function () {
    ...
    this.createSource().then(function (wait) {
      ...
      if (JSON.parse('["aniliberty","eneida","fxpro","filmix","hdrezka","hdr","iremux","kinopub","kinotochka","mango","starlight","uaflix"]').indexOf((balanser.indexOf('<') == - 1 ? balanser.toLowerCase() : balanser.split('<')[0].toLowerCase())) == -1) {
  ...
  this.requestParams = function (url) {
    ...
    query.push('cub_id=ZWdvcmtvcm90a292NUBnbWFpbC5jb20=');
    query.push('uid=bb04b81f6297b1b6280ea8273_234350575');
    if (cards) {
      var notices = Lampa.Storage.get('account_notice', []).filter(function (n) {
		...
		this.get = function () {
			if (object.url && object.url.indexOf('pub/tvs') > -1) {
				network.silent(object.url, _this1.build.bind(this), function (json) {
					...
					id: 'ZWdvcmtvcm90a292NUBnbWFpbC5jb20=',
					uid: 'bb04b81f6297b1b6280ea8273_234350575'
				});
				...
				var pl = [{"name":"Modss","url":"modss"},{"name":"Free","url":"free"}]
				_this1.list(pl);
			}
		};
		this.parsePlaylist = function (data) {
			var postdata = data ? { datas: data, id: 'ZWdvcmtvcm90a292NUBnbWFpbC5jb20=', uid: 'bb04b81f6297b1b6280ea8273_234350575' } : { url: object.url, id: 'ZWdvcmtvcm90a292NUBnbWFpbC5jb20=', uid: 'bb04b81f6297b1b6280ea8273_234350575' };
...
// https://codeberg.org/cuschk/somafm
 ...
 //# sourceURL=http://lampa.mx/plugin_modss.js